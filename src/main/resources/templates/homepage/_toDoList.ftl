                                        ...
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                ...
                                                <form action="/newTask" METHOD="POST" class="form-horizontal form-label-left input_mask">
                                                    ...
                                                    <div class="col-md-30 col-sm-30 col-xs-26 form-group has-feedback">
                                                        Description
                                                        <textarea id="description" required="required" placeholder="Description" class="form-control" name="description" data-parsley-trigger="keyup" data-parsley-minlength="4" data-parsley-maxlength="20"  data-parsley-validation-threshold="10"></textarea>
                                                    </div>
