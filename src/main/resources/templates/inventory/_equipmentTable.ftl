<#if isAdmin><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#equipment">New Equipment</button><#else><strong>Sign in as an ADMIN to register new equipment</strong></#if>
