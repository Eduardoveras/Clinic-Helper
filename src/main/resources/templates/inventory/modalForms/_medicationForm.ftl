<div class="x_panel">
    <div class="x_title">
        <h2><@spring.message "medicationForm" /></h2>
        <div class="clearfix"></div>
    </div>
    <div class="x_content">
        <br>
        <form action="/newMedication" METHOD="POST" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
            ...
            <div class="form-group">
                <label for="price" class="control-label col-md-3 col-sm-3 col-xs-12"><@spring.message "price" /> </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
