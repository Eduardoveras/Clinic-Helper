...
--INSERT INTO chore (user_user_id, chore_id, description, title, type, completed) VALUES ('CH-JASC-YOLO', 'JASC-M-9URHFDN', 'By more Bras', 'Inventory refill', 4, FALSE);
--INSERT INTO chore (user_user_id, chore_id, description, title, type, completed) VALUES ('CH-JASC-YOLO', 'JASC-M-9UR23DN', 'Call Accountant', 'Finance', 6, FALSE);
