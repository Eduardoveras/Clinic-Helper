...
/*
    ...
    Patient findRegisteredPatientByFLTEFields(@Param("firstName") String firstName, @Param("lastName") String lastName, @Param("telephone") String telephone, @Param("email") String email);
*/
}
